...
@implementation UIButton (SKEdgeInsets)
...
- (void)setButtonImageTitleStyle:(ButtonImageTitleStyle)style padding:(CGFloat)padding
{
    if (self.imageView.image != nil && self.titleLabel.text != nil) {
        ...
        CGFloat selfHeight = self.frame.size.height; //按钮控件的宽度
        CGFloat selfWidth = self.frame.size.width; //按钮控件的高度
