...
@interface SKOutlineViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SKOutlineCell *cell = [tableView dequeueReusableCellWithIdentifier:outlineViewControllerCellID forIndexPath:indexPath];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"SKOutlineCell" bundle:nil] forCellReuseIdentifier:outlineViewControllerCellID];
