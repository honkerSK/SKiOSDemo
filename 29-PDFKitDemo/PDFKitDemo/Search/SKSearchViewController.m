...
@interface SKSearchViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,PDFDocumentDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SKSearchCell *cell = [tableView dequeueReusableCellWithIdentifier:searchViewControllerTableViewCellID forIndexPath:indexPath];
    ...
    NSString *destinationStr = [NSString stringWithFormat:@"%@  页码: %@", outline.label, page.label];
...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"SKSearchCell" bundle:nil] forCellReuseIdentifier:searchViewControllerTableViewCellID];
