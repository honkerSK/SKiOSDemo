...
//  SK3DTouchDemo
//
//  Created by sunke on 2016/8/20.
//  Copyright © 2016 sunke. All rights reserved.
//

#import "SKMainViewController.h"
#import "SKPresentationViewController.h"

static NSString *reusedId = @"3dTouch";

@interface SKMainViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SKPresentationViewController *presentationVC = [[SKPresentationViewController alloc] init];
