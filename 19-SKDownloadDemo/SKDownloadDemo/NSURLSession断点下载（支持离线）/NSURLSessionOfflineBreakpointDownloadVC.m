//
//  NSURLSessionOfflineBreakpointDownloadVC.m
//  SKDownloadDemo
//
//  Created by sunke on 26/11/2018.
//  Copyright © 2018 sunke. All rights reserved.
//

#import "NSURLSessionOfflineBreakpointDownloadVC.h"

@interface NSURLSessionOfflineBreakpointDownloadVC ()<NSURLSessionDataDelegate>
...
@implementation NSURLSessionOfflineBreakpointDownloadVC
...
- (NSURLSessionDataTask *)downloadTask {
    if (!_downloadTask) {
        // 创建下载URL
        NSURL *url = [NSURL URLWithString:@"http://down.sandai.net/mac/thunder_3.2.8.3776.dmg"];
 ...
 */
- (IBAction)OfflinBreakpointDownloadBtnClicked:(UIButton *)sender {
    // 按钮状态取反
    sender.selected = !sender.isSelected;
    
    if (sender.selected) { // [开始下载/继续下载]
        // 沙盒文件路径
        NSString *path = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"thunder_3.2.8.3776.dmg"];
