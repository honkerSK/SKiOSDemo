//
//  NSURLSessionDelegateDownloadVC.m
//  SKDownloadDemo
//
...
@interface NSURLSessionDelegateDownloadVC ()<NSURLSessionDownloadDelegate>
...
@implementation NSURLSessionDelegateDownloadVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"NSURLSession的delegate方式下载文件";
}
...
didFinishDownloadingToURL:(NSURL *)location
{
    ...
    // 新文件路径
    NSString *newFilePath = [documentsPath stringByAppendingPathComponent:@"thunder_3.2.8.3776.dmg"];
